      ...
      <div class="col-md-8">
        <?php if($this->session->flashdata('message_e')){ ?>      
          ...
          <div class="box box-success">
            <form role="form" method="post" action="<?= base_url()?>generos/insertSub">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-success btn-sm">REGISTRAR NUEVO SUBGENERO</button> ó <a href="#">Cancelar</a>
              </div>
            </form>
          </div>    
      </div>
